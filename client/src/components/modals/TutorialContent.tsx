      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li>Make sure you're on the BASE test network to participate in the lottery.</li>
            <li>You can get test ETH from the BASE faucet if needed for transactions.</li>
          </ul>
        </section>
        ...
        <div className="mt-8 p-4 bg-black/10 rounded-lg">
          <p className="text-lg italic">
            Note: This is a DApp running on the BASE testnet. While the gameplay mirrors a real lottery, it uses test ETH, not real currency.
          </p>
        </div>
      </div>
    </div>
